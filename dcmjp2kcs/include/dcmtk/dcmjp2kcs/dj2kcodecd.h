...
#ifndef DCMJP2KCS_DJ2KCODECD_H
#define DCMJP2KCS_DJ2KCODECD_H
 ...
 */
class DCMTK_DCMJP2KCS_EXPORT DJ2KDecoderBase: public DcmCodec
{
public:
 ...
 */
class DCMTK_DCMJP2KCS_EXPORT DJ2KLosslessDecoder : public DJ2KDecoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to decode
   *  @return supported transfer syntax
 ...
 */
class DCMTK_DCMJP2KCS_EXPORT DJ2KDecoder : public DJ2KDecoderBase
{
  /** returns the transfer syntax that this particular codec
   *  is able to decode
   *  @return supported transfer syntax
